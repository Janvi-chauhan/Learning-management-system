...
const activities = [
  {
    ...
    description: "React Dashboard Task is now available.",
    time: "20 mins ago",
    icon: FileText,
    color: "blue",
  },
  {
    ...
    description: "Python course notes were uploaded.",
    time: "2 hours ago",
    icon: BookOpen,
    color: "red",
  },
  {
    ...
    description: "Your attendance is now 89%.",
    time: "Today",
    icon: CheckCircle,
    color: "green",
  },
  ...
  },
  {
    ...
    description: "Assignment deadline is tomorrow.",
    time: "Today",
    icon: Bell,
    color: "yellow",
  },
